...
################### INTESTINE 
############################################################################### 
resDir = "/data/projects/2023/LCBiome/nsclc_gender_atlas_tmp/out/007_re_analysis/figures/GSEA_ORA/"
inputDir = "/data/projects/2023/LCBiome/nsclc_gender_atlas_tmp/out/007_re_analysis/tables/GSEA_ORA"
data_normal<-as.data.frame(fread(paste0(inputDir,"/normal/nsclc_gender_normal_GSEA_KEGG.tsv")))
data_tumor <- as.data.frame(fread(paste0(inputDir,"/tumor/nsclc_gender_tumor_GSEA_KEGG.tsv")))
data_tumor_and_normal <- as.data.frame(fread(paste0(inputDir,"/tumor_and_normal/nsclc_gender_tumor_and_normal_GSEA_KEGG.tsv")))
...
###################################################################
data_normal<-as.data.frame(fread(paste0(inputDir,"/normal/nsclc_gender_normal_ORA_GO_BP.tsv")))
data_tumor <- as.data.frame(fread(paste0(inputDir,"/tumor/nsclc_gender_tumor_ORA_GO_BP.tsv")))
data_tumor_and_normal <- as.data.frame(fread(paste0(inputDir,"/tumor_and_normal/nsclc_gender_tumor_and_normal_ORA_GO_BP.tsv")))
data_normal$condition = "normal"
data_tumor$condition = "tumor"
data_tumor_and_normal$condition = "tumor_normal"
...
########################################################
data_normal<-as.data.frame(fread(paste0(inputDir,"/normal/nsclc_gender_normal_ORA_GO_CC.tsv")))
data_tumor <- as.data.frame(fread(paste0(inputDir,"/tumor/nsclc_gender_tumor_ORA_GO_CC.tsv")))
data_tumor_and_normal <- as.data.frame(fread(paste0(inputDir,"/tumor_and_normal/nsclc_gender_tumor_and_normal_ORA_GO_CC.tsv")))
data_normal$condition = "normal"
data_tumor$condition = "tumor"
data_tumor_and_normal$condition = "tumor_normal"
...
resDir = "/data/projects/2023/LCBiome/nsclc_gender_atlas_tmp/out/007_re_analysis/figures/GSEA_ORA/"
inputDir = "/data/projects/2023/LCBiome/nsclc_gender_atlas_tmp/out/007_re_analysis/tables/GSEA_ORA"
data_normal<-as.data.frame(fread(paste0(inputDir,"/normal/nsclc_gender_normal_GSEA_GO_BP.tsv")))
data_tumor <- as.data.frame(fread(paste0(inputDir,"/tumor/nsclc_gender_tumor_GSEA_GO_BP.tsv")))
data_tumor_and_normal <- as.data.frame(fread(paste0(inputDir,"/tumor_and_normal/nsclc_gender_tumor_and_normal_GSEA_GO_BP.tsv")))
data_normal$condition = "normal"
data_tumor$condition = "tumor"
data_tumor_and_normal$condition = "tumor_normal"
